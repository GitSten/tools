const emojiData = [
  ...
  { emoji: '😁', name: 'Beaming Face', category: 'Smileys', keywords: ['grin', 'happy', 'smile'], unicode: 'U+1F601', popular: 91 },
  { emoji: '😆', name: 'Grinning Squinting Face', category: 'Smileys', keywords: ['laugh', 'lol', 'funny'], unicode: 'U+1F606', popular: 90 },
  { emoji: '🤩', name: 'Star-Struck', category: 'Smileys', keywords: ['wow', 'impressed', 'sparkle'], unicode: 'U+1F929', popular: 92 },
  { emoji: '😎', name: 'Smiling Face With Sunglasses', category: 'Smileys', keywords: ['cool', 'chill', 'slick'], unicode: 'U+1F60E', popular: 89 },
  { emoji: '🥳', name: 'Partying Face', category: 'Smileys', keywords: ['party', 'celebrate', 'fun'], unicode: 'U+1F973', popular: 87 },
  { emoji: '🤔', name: 'Thinking Face', category: 'Smileys', keywords: ['think', 'hmm', 'question'], unicode: 'U+1F914', popular: 85 },
  { emoji: '😭', name: 'Loudly Crying Face', category: 'Smileys', keywords: ['cry', 'sad', 'tears'], unicode: 'U+1F62D', popular: 88 },
  { emoji: '😴', name: 'Sleeping Face', category: 'Smileys', keywords: ['sleep', 'tired', 'nap'], unicode: 'U+1F634', popular: 73 },
  { emoji: '😡', name: 'Pouting Face', category: 'Smileys', keywords: ['angry', 'mad', 'annoyed'], unicode: 'U+1F621', popular: 72 },
  { emoji: '🤗', name: 'Hugging Face', category: 'Smileys', keywords: ['hug', 'warm', 'friendly'], unicode: 'U+1F917', popular: 84 },
  { emoji: '👋', name: 'Waving Hand', category: 'People', keywords: ['hello', 'bye', 'wave'], unicode: 'U+1F44B', popular: 88 },
  { emoji: '🤝', name: 'Handshake', category: 'People', keywords: ['deal', 'agreement', 'team'], unicode: 'U+1F91D', popular: 82 },
  { emoji: '👍', name: 'Thumbs Up', category: 'People', keywords: ['yes', 'approve', 'good'], unicode: 'U+1F44D', popular: 96 },
  { emoji: '👌', name: 'OK Hand', category: 'People', keywords: ['okay', 'perfect', 'fine'], unicode: 'U+1F44C', popular: 86 },
  { emoji: '✋', name: 'Raised Hand', category: 'People', keywords: ['stop', 'hi', 'hand'], unicode: 'U+270B', popular: 76 },
  { emoji: '🤞', name: 'Crossed Fingers', category: 'People', keywords: ['luck', 'hope', 'wish'], unicode: 'U+1F91E', popular: 81 },
  { emoji: '🌸', name: 'Cherry Blossom', category: 'Nature', keywords: ['flower', 'spring', 'soft'], unicode: 'U+1F338', popular: 85 },
  { emoji: '🌼', name: 'Blossom', category: 'Nature', keywords: ['flower', 'bloom', 'yellow'], unicode: 'U+1F33C', popular: 74 },
  { emoji: '🌙', name: 'Crescent Moon', category: 'Nature', keywords: ['night', 'moon', 'calm'], unicode: 'U+1F319', popular: 83 },
  { emoji: '🌊', name: 'Water Wave', category: 'Nature', keywords: ['ocean', 'wave', 'sea'], unicode: 'U+1F30A', popular: 78 },
  { emoji: '🍀', name: 'Four Leaf Clover', category: 'Nature', keywords: ['luck', 'green', 'chance'], unicode: 'U+1F340', popular: 84 },
  { emoji: '🍓', name: 'Strawberry', category: 'Food', keywords: ['fruit', 'sweet', 'pink'], unicode: 'U+1F353', popular: 79 },
  { emoji: '🍇', name: 'Grapes', category: 'Food', keywords: ['fruit', 'wine', 'purple'], unicode: 'U+1F347', popular: 71 },
  { emoji: '🍪', name: 'Cookie', category: 'Food', keywords: ['biscuit', 'dessert', 'snack'], unicode: 'U+1F36A', popular: 82 },
  { emoji: '🍩', name: 'Doughnut', category: 'Food', keywords: ['donut', 'sweet', 'dessert'], unicode: 'U+1F369', popular: 80 },
  { emoji: '🥑', name: 'Avocado', category: 'Food', keywords: ['healthy', 'green', 'toast'], unicode: 'U+1F951', popular: 77 },
  { emoji: '🧋', name: 'Bubble Tea', category: 'Food', keywords: ['tea', 'boba', 'drink'], unicode: 'U+1F9CB', popular: 76 },
  { emoji: '🥞', name: 'Pancakes', category: 'Food', keywords: ['breakfast', 'syrup', 'stack'], unicode: 'U+1F95E', popular: 69 },
  { emoji: '🚗', name: 'Car', category: 'Travel', keywords: ['drive', 'road', 'auto'], unicode: 'U+1F697', popular: 80 },
  { emoji: '🚲', name: 'Bicycle', category: 'Travel', keywords: ['bike', 'ride', 'transport'], unicode: 'U+1F6B2', popular: 68 },
  { emoji: '🏖️', name: 'Beach With Umbrella', category: 'Travel', keywords: ['vacation', 'summer', 'sun'], unicode: 'U+1F3D6', popular: 74 },
  { emoji: '🗺️', name: 'World Map', category: 'Travel', keywords: ['map', 'travel', 'route'], unicode: 'U+1F5FA', popular: 67 },
  { emoji: '🏕️', name: 'Camping', category: 'Travel', keywords: ['tent', 'outdoors', 'camp'], unicode: 'U+1F3D5', popular: 69 },
  { emoji: '🛳️', name: 'Passenger Ship', category: 'Travel', keywords: ['ship', 'cruise', 'sea'], unicode: 'U+1F6F3', popular: 61 },
  { emoji: '📎', name: 'Paperclip', category: 'Objects', keywords: ['attach', 'clip', 'office'], unicode: 'U+1F4CE', popular: 63 },
  { emoji: '📝', name: 'Memo', category: 'Objects', keywords: ['note', 'write', 'edit'], unicode: 'U+1F4DD', popular: 81 },
  { emoji: '🧪', name: 'Test Tube', category: 'Objects', keywords: ['science', 'lab', 'experiment'], unicode: 'U+1F9EA', popular: 70 },
  { emoji: '⚙️', name: 'Gear', category: 'Objects', keywords: ['settings', 'system', 'options'], unicode: 'U+2699', popular: 65 },
  { emoji: '🧭', name: 'Compass', category: 'Objects', keywords: ['direction', 'navigate', 'guide'], unicode: 'U+1F9ED', popular: 66 },
  { emoji: '🛰️', name: 'Satellite', category: 'Objects', keywords: ['space', 'signal', 'orbit'], unicode: 'U+1F6F0', popular: 60 },
  { emoji: '🧱', name: 'Brick', category: 'Objects', keywords: ['build', 'block', 'wall'], unicode: 'U+1F9F1', popular: 59 },
  { emoji: '🎁', name: 'Gift', category: 'Symbols', keywords: ['present', 'surprise', 'box'], unicode: 'U+1F381', popular: 86 },
  { emoji: '🔔', name: 'Bell', category: 'Symbols', keywords: ['alert', 'notification', 'ring'], unicode: 'U+1F514', popular: 74 },
  { emoji: '💯', name: 'Hundred Points', category: 'Symbols', keywords: ['perfect', '100', 'score'], unicode: 'U+1F4AF', popular: 83 },
  { emoji: '🎊', name: 'Confetti Ball', category: 'Symbols', keywords: ['celebrate', 'party', 'confetti'], unicode: 'U+1F38A', popular: 79 },
  { emoji: '🏁', name: 'Chequered Flag', category: 'Symbols', keywords: ['finish', 'race', 'goal'], unicode: 'U+1F3C1', popular: 64 },
  { emoji: '🧡', name: 'Orange Heart', category: 'Symbols', keywords: ['love', 'warm', 'heart'], unicode: 'U+1F9E1', popular: 78 },
  { emoji: '💜', name: 'Purple Heart', category: 'Symbols', keywords: ['love', 'support', 'heart'], unicode: 'U+1F49C', popular: 76 }
];
